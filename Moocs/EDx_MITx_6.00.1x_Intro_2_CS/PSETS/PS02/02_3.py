...
# running on our servers, there are limits on the amount of computing time each submission is allowed, s
# o your observations from running this experiment on the grading system might be
...
# lower bound for this payment value? $0 is the obvious anwer, but you can do better than that.
...
# low and high are bounds for finding minimum fixed monthly payment
low = balance / 12
high = (balance * (1 + monthlyInterestRate) ** 12) / 12.0

updatedBalance = balance

while round(updatedBalance, 2) != 0:
        minimumMonthlyPayment = (low + high) / 2
        updatedBalance = balance

        # For looping over the entire year, month 1 to 12
