...
# First, test the middle character of a string against the
# character you're looking for (the "test character"). If they are the same,
# we are done - we've found the character we're looking for!
# If they're not the same, check if the test character is "smaller"
# than the middle character. If so, we need only consider the lower half of the
